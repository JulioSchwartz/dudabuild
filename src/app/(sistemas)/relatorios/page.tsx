...
export default function Relatorios() {
  ...
  }, [empresaId, inicio, fim, obraFiltro])
  ...
  const filtrando = inicio || fim || obraFiltro
    ...
    <div style={{ padding: 24 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20 }}>
        <div>
          ...
          <p style={subtitulo}>Análise detalhada por período e obra</p>
        </div>
      ...
      <div style={filtroCard}>
        ...
        <div style={filtroRow}>
          ...
          <div style={{ display: 'flex', gap: 8, alignItems: 'flex-end' }}>
            ...
            {filtrando && (
              <button onClick={() => { setInicio(''); setFim(''); setObraFiltro('') }} style={btnLimpar}>
                Limpar
              </button>
            )}
          </div>
      ...
      {dados.length === 0 && (
        <div style={vazioCard}>
          ...
          <p style={{ fontWeight: 600, color: '#0f172a' }}>Nenhum lançamento encontrado</p>
...
function Metrica({ label, valor, cor, icone }: any) {
  return (
