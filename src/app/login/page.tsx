...
export default function Login() {
  ...
  return (
    <div style={container}>
      <div style={card}>
        <div style={logoArea}>
          <img src="/Logotipo_16_9_-_Zynplan.png" alt="Zynplan" style={{ width: 220, display: 'block', margin: '0 auto 8px' }} />
...
const card: React.CSSProperties          = { background: '#0f172a', padding: 36, borderRadius: 16, width: '100%', maxWidth: 400, color: '#fff', boxShadow: '0 20px 60px rgba(0,0,0,0.6)', border: '1px solid #1e293b' }
